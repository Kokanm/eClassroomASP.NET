        ...
        if(names.indexOf(username) == passwords.indexOf(pass)){
            ...
            switch(username){
                case "student@mail.com":
                    user.innerHTML = "You are logged in as <a href='myprofile.html'>Student</a> (<a href='index.aspx'>log out</a>) ";
                    break;
                case "profesor@mail.com":
                    user.innerHTML = "You are logged in as <a href='myprofile.html'>Profesor</a> (<a href='index.aspx'>log out</a>) ";
                    break;
                case "administrator":
                    user.innerHTML = "You are logged in as <a href='myprofile.html'>Administrator</a> (<a href='index.aspx'>log out</a>) ";
                    break;
            }
            return true;
        }else{
